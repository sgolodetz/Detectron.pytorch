...
extern "C" int roi_pooling_forward_cuda(int pooled_height, int pooled_width, float spatial_scale,
...
extern "C" int roi_pooling_backward_cuda(int pooled_height, int pooled_width, float spatial_scale,
